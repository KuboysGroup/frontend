...
class PedidosSistemasScreen extends HookConsumerWidget {
  const PedidosSistemasScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final pedidosList = ref.watch(pedidosSistemasStateProvider);

    ref.watch(pedidoSistemaSelecionadoStateProvider);
            ...
            children: [
              const Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Pedidos de Sistema de Câmara Quente',
                        ...
                        ...data.map((e) => Padding(
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  ref
                                      .read(
                                          pedidoSistemaSelecionadoStateProvider
                                              .notifier)
                                      .selecionarPedido(e);
                                  context.go(
                                      '/pedidos_sistemas/pedido_sistema_selecionado');
                                },
