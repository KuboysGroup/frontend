...
class PedidosFerramentasScreen extends HookConsumerWidget {
  const PedidosFerramentasScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final pedidosList = ref.watch(pedidosFerramentasStateProvider);

    ref.watch(pedidoFerramentaSelecionadoStateProvider);
